...
namespace ApiGateway.Middlewares
{
    public class RequestResponseLoggingMiddleware
    {
        ...
        public RequestResponseLoggingMiddleware(RequestDelegate next, ILogger<RequestResponseLoggingMiddleware> logger, ILogsService logsService)
        {
            _next = next;
            _logger = logger;
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            await logsService.CreateAsync(new Logs()
            {
                Request = request,
                Response = response,
